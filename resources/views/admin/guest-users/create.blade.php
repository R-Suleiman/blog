...
@section('content')
    ...
    <section class="w-11/12 mx-auto p-2">
        ...
        <div class="w-full mx-auto border border-green-400 my-8 p-2 md:p-4 flex flex-col items-center">
            <h3 class="text-3xl text-green-400 font-semibold mb-4">Register new User</h3>

            <form action="{{ route('admin.guest-user.store') }}" method="POST" enctype="multipart/form-data"
