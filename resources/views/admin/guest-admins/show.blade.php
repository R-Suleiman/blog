...
<section class="w-11/12 mx-auto p-2">
    ...
    <div class="w-full mx-auto md:p-2 my-8">
        ...
        @if ($admin->topics->count() > 0)
            @foreach ($admin->topics as $topic)
            <div class="w-full bg-green-50 p-2 my-2">
                ...
                <div class="my-2 px-2">
                    ...
                    <h4 class="text-xl font-semibold hover:text-green-600"><a href="{{ route('admin.topic.show', ['which_topics' => 'other', 'topic' => $topic]) }}">{{ $topic->title }}</a>
                    </h4>
                </div>
