...
@section('content')
    ...
    <section class="w-11/12 mx-auto p-2">
        ...
        <div class="w-full mx-auto border border-green-400 my-8 p-2 md:p-4 flex flex-col items-center">
            ...
            <form action="{{ route('admin.guest-admin.update', $admin) }}" method="POST" enctype="multipart/form-data" class="w-full p-2 my-4">
                @csrf
                @method('PUT')
                ...
                <div class="w-full p-2">
                    ...
                    <div>
                        ...
                        <input type="checkbox" name="rank" class="border border-green-400 text-xl p-2 outline-none mx-2" {{ $admin->rank == 1 ? 'checked' : ''}}>
                    </div>
